...
d30 = read.csv('indata/Circle_Lombalgia_Pernas_Costas.csv', encoding = 'UTF-8')
...
tiff('outputdata/imgs/Lombar_Costas_Pernas.tiff', width = 20, height = 20, units ='in', res = 300)
p
dev.off()


# Cirurgia_Coluna e Desemprego --------------------------------------------
...
data_sur_job = read.csv('indata/Cirurgia_coluna_Desempregado_CrossTable.csv', encoding = 'UTF-8')
...
tiff('outputdata/imgs/Cirurgia_Trabalho_Crosstable.tiff', width = 20, height = 20, units ='in', res = 300)
p
dev.off()
