...
classificador.add(Dense(units = neurons, activation = 'sigmoid', input_dim = int(X_train.shape[1])))
...
classificador = RandomForestClassifier(n_estimators=1, 
                                       criterion = 'gini', 
                                       max_depth = 1)
...
# evaluate model
scores = cross_validate(model, X_pca, y, 
